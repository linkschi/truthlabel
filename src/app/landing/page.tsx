...
const checkCards = [
  {
    ...
    copy: (
      <>
        Items <span className="landing-highlight">banned or restricted</span> in
        supported regions.
      </>
    ),
    icon: "ban",
  },
  {
    ...
    copy: (
      <>
        Ingredients matching your <span className="landing-highlight">allergy</span>{" "}
        list.
      </>
    ),
    icon: "shield",
  },
  {
    ...
    copy: (
      <>
        Ingredients with <span className="landing-highlight">serious</span>{" "}
        long-term concern signals.
      </>
    ),
    icon: "alert",
  },
  ...
  },
  {
    ...
    copy: (
      <>
        Category or verified <span className="landing-highlight">safety signals</span>.
      </>
    ),
    icon: "lab",
  },
  ...
  },
  {
    ...
    copy: (
      <>
        <span className="landing-highlight">Recalls</span>, alerts, and safety
        actions.
      </>
    ),
    icon: "signal",
...
const trustItems = [
  {
    ...
    copy: (
      <>
        <span className="landing-highlight">Serious findings</span> explain the
        ingredient, concern type, and supporting reason.
      </>
    ),
  },
  {
    ...
    copy: (
      <>
        Possible concerns, <span className="landing-highlight">confirmed dangers</span>,
        personal preferences, and overload warnings are described differently.
      </>
    ),
  },
  {
    ...
    <main className="landing-page">
      ...
      <section className="landing-concerns">
        <SectionIntro
          ...
          title="These are the items and practices appearing more often in everyday food."
        />
