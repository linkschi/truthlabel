    ...
    <section className="mt-8 border-t border-[var(--border-soft)] pt-4">
      <div className="flex justify-center">
        <button
          ...
          className="rounded-full border border-transparent px-3 py-1.5 text-[11px] font-semibold text-[var(--text-muted)] transition hover:border-[var(--border-soft)] hover:bg-[var(--bg-soft)] hover:text-[var(--text-secondary)] active:scale-[0.99]"
        >
          {isOpen ? "Close issue report" : "Report an issue"}
        </button>
      </div>

      {isOpen ? (
        <div className="mt-4 space-y-3 rounded-[20px] border border-[var(--border-soft)] bg-[var(--bg-surface)] px-4 py-4 shadow-[0_14px_28px_rgba(23,20,18,0.05)]">
